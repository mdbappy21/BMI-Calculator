...
def BMI():
    ...
    if bmi <= 18.5:
        ...
        label3.config(text="You have lower weight than normal\nbody! Prioritize nutrient-dense foods,\nincrease caloric intake, and incorporate\nresistance training for muscle gain")
    elif 18.5 < bmi <= 25:
        label2.config(text="Normal!")
        label3.config(text="you are healthy. Maintain balanced \nnutrition and regular exercise for\noverall health and well-being.")
    elif 25 < bmi <= 30:
        label2.config(text="OverWeight!")
        label3.config(
            text="you are slightly overweight !\nFocus on portion control, whole\nfoods, and a combination of aerobic and\n strength training exercises.")
    else:
        label2.config(text="Obes!!")
        label3.config(text="Your health is at risk . Advocate\nfor personalized dietary plans, structured \nworkouts, and comprehensive support to \nachieve lasting weight control and \noverall health.")
